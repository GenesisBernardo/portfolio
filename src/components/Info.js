...
const Info = () => {
    ...
    const info = useSpring({opacity: 1, delay: 2500, from: {opacity: 0}})
    const infoo = useSpring({opacity: 1, delay: 2600, from: {opacity: 0}})

    return (
        <div>
            <animated.div className="info-left" style={info}>
                <ul className="info-svg">
                    <li>
                        <a href="https://github.com/GenesisBernardo" aria-label="GitHub" target="_blank" rel="noopener noreferrer">
                            <svg xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 24 24" fill="none" stroke="currentColor" 
                                ...
                                <path d="M9 19c-5 1.5-5-2.5-7-3m14 6v-3.87a3.37 3.37 0 0 0-.94-2.61c3.14-.35 
                                    ...
                                    13.38 0 0 0-7 0C6.27.65 5.09 1 5.09 1A5.07 5.07 0 0 0 5 4.77a5.44 5.44 0 0 0-1.5 3.78c0 5.42 
            ...
            <animated.div className="info-right" style={infoo}>
                <div className="email">
                    <a href="mailto:genesisbernardo123@gmail.com">
                        genesisbernardo123@gmail.com
                    </a>
                </div>
            </animated.div>
        </div>
